({
    ...
    viewIdea : function(component, event, helper){ 
        helper.displayIdea(component,event,helper);
    },
    handleDisLikeButtonClick:function(component,event,helper) {
        component.set('v.Disliked', component.get('v.Disliked'));
    },
    handleDisLikeButtonClick:function(component,event,helper) {
        component.set('v.Liked', component.get('v.Liked')+1);
    },
     handleLikeButtonClick1 : function(component,event,helper) {
         
        var action = component.get('c.handleLikeButtonClickon');
        var ideaIdx = event.target.id;
        var ideas=10;
        ...
        action.setCallback(this, function(response){
         var state = response.getState();
             ...
             {
                 ideas=ideas+1;
              component.set('v.Liked',parseInt(like)+1);
              $A.get('e.force:refreshView').fire();
    ...
    handleDisLikeButtonClick1 : function(component,event,helper) {
        
        var action = component.get('c.handleDisLikeButtonClickon');
        var ideaIdx = event.target.id;
